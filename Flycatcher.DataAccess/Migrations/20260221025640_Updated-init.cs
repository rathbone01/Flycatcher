        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_UserFriend_UserId_NotEqual_FriendId", "[UserId] <> [FriendId]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeleteOthersMessages = table.Column<bool>(type: "bit", nullable: false),
                    TimeoutUser = table.Column<bool>(type: "bit", nullable: false),
                    BanUser = table.Column<bool>(type: "bit", nullable: false),
                    EditChannels = table.Column<bool>(type: "bit", nullable: false),
                    AddChannels = table.Column<bool>(type: "bit", nullable: false),
                    EditServerSettings = table.Column<bool>(type: "bit", nullable: false),
                    ManageRoles = table.Column<bool>(type: "bit", nullable: false),
                    AssignRoles = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
